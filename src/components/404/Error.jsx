    ...
    return (
        <section className="container-padding grid grid-cols-1 md:grid-cols-2 gap-6 justify-center items-center">
            <div className="space-y-6">
                <h1 className="heading text-red-600">Oops, Wrong Turn...</h1>
                <p className="text-lg lg:w-[75%]">
                    Looks like you've wandered off the beaten path. Let's get
                    you back on track and find what you are looking for
                </p>
                <button
                    onClick={() => navigate("/")}
